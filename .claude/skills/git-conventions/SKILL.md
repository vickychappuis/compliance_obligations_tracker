...
- Never create commits, branches, or PRs without explicit confirmation from the user first
- Always propose (branch name + commit message) and wait for approval before executing
